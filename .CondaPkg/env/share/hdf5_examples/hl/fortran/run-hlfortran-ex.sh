...
prefix="${prefix:-/work/Multisensory_HGF/.CondaPkg/env}"
PARALLEL=no             # Am I in parallel mode?
AR="/home/conda/feedstock_root/build_artifacts/hdf5_1701790417120/_build_env/bin/x86_64-conda-linux-gnu-ar"
RANLIB="/home/conda/feedstock_root/build_artifacts/hdf5_1701790417120/_build_env/bin/x86_64-conda-linux-gnu-ranlib"
if [ "$PARALLEL" = no ]; then
