...
#define CONFIGURE_ARGS " '--prefix=/work/Multisensory_HGF/.CondaPkg/env' '--with-readline' '--with-libraries=/work/Multisensory_HGF/.CondaPkg/env/lib' '--without-icu' '--with-includes=/work/Multisensory_HGF/.CondaPkg/env/include' '--with-openssl' '--with-uuid=e2fs' '--with-libxml' '--with-libxslt' '--with-gssapi' '--with-system-tzdata=/work/Multisensory_HGF/.CondaPkg/env/share/zoneinfo' 'PG_SYSROOT=undefined' 'build_alias=x86_64-conda-linux-gnu' 'host_alias=x86_64-conda-linux-gnu' 'CC=x86_64-conda-linux-gnu-cc' 'CFLAGS=-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /work/Multisensory_HGF/.CondaPkg/env/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/postgresql-split_1702129480996/work=/usr/local/src/conda/postgresql-split-16.1 -fdebug-prefix-map=/work/Multisensory_HGF/.CondaPkg/env=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,--allow-shlib-undefined -Wl,-rpath,/work/Multisensory_HGF/.CondaPkg/env/lib -Wl,-rpath-link,/work/Multisensory_HGF/.CondaPkg/env/lib -L/work/Multisensory_HGF/.CondaPkg/env/lib' 'CPPFLAGS=-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /work/Multisensory_HGF/.CondaPkg/env/include' 'CXX=x86_64-conda-linux-gnu-c++' 'CXXFLAGS=-fvisibility-inlines-hidden -fmessage-length=0 -march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /work/Multisensory_HGF/.CondaPkg/env/include -fdebug-prefix-map=/home/conda/feedstock_root/build_artifacts/postgresql-split_1702129480996/work=/usr/local/src/conda/postgresql-split-16.1 -fdebug-prefix-map=/work/Multisensory_HGF/.CondaPkg/env=/usr/local/src/conda-prefix' 'CPP=/home/conda/feedstock_root/build_artifacts/postgresql-split_1702129480996/_build_env/bin/x86_64-conda-linux-gnu-cpp' 'PKG_CONFIG_PATH=/work/Multisensory_HGF/.CondaPkg/env/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 16.1 on x86_64-conda-linux-gnu, compiled by x86_64-conda-linux-gnu-cc (conda-forge gcc 12.3.0-3) 12.3.0, 64-bit"
